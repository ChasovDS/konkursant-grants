    ...
    <Grid item xs={12} md={4}>
      ...
      <Card sx={{ backgroundColor: theme.palette.background.paper }}>
        <CardHeader
          ...
          title={`${formData.first_name || 'Имя'} ${formData.last_name || 'Фамилия'}`}
          subheader={roleTranslations[formData.role_name] || 'Роль'} // Map role to Russian or show default
        />
      </Card>
        ...
        <CardContent>
          ...
          <CardContent sx={{ mb: -4 }}>
            <FormControl component="fieldset" disabled>
              ...
              <RadioGroup
                //name="privacy_settings.view_permission"
                //value={formData.privacy_settings?.view_permission || 'expertsOnly'}
              >
